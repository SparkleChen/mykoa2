...
var A = function (_React$Component) {
    ...
    _createClass(A, [{
        ...
        value: function componentDidMount() {
            ...
            var url = 'http://localhost:3000/home/getUser';
            var data = {
                name: "leo"
            };
            var doFetch = new _fetch2.default();

            doFetch.post(url, data, function (res) {
                _this2.setState({
                    name: res.name,
                    email: res.email,
                    age: res.age
...
_reactDom2.default.render(_react2.default.createElement(A, null), document.getElementById('oo'));
...
var fetchs = function () {
    function fetchs() {
        _classCallCheck(this, fetchs);
    }

    _createClass(fetchs, [{
        key: "fetchAsync",
        value: async function fetchAsync(url, method, data, callback) {
